...
project = u'Školení GeoPython pro pokročilé'
copyright = u'2015-%d, Jáchym Čepický, Martin Landa a Ľudmila Furtkevičová (GISMentors.cz)' % get_year()
...
htmlhelp_basename = 'Skoleni-GeoPython-Pokrocily'
