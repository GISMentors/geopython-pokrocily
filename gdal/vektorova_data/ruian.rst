...
Tato kapitola prezentuje komplexní příklad použití knihovny GDAL pro
čtení online dat z *Registru územní identifikace, adres a nemovitostí*
(`RÚIAN <http://ruian.cz>`__) dostupných v rámci `Veřejného dálkové
přístupu <http://vdp.cuzk.cz>`__.

Pro zadanou obec (řádek :lcode:`8`) vypíše informace o parcelách
(parcelní číslo, výměru uloženou v atributech a vypočtenou z
